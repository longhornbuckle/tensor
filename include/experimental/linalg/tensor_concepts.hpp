...
template < class T1, class T2, class = void > struct may_have_equal_extents_v : public ::std::false_type { };
template < class T1, class T2 > struct may_have_equal_extents< T1, T2, ::std::enable_if_t< LINALG_DETAIL::extents_maybe_equal_v< typename FirstTensor::extents_type, typename SecondTensor::extents_type > > > : public ::std::true_type { };
...
template < class T1, class T2 > struct has_equal_ranks< T1, T2, ::std::enable_if_t< ( FirstTensor::rank() == SecondTensor::rank() ) > > : public ::std::true_type { };
...
template < class T1, class T2 > struct elements_are_additive< T1, T2, ::std::enable_if_t< ::std::is_same_v< ( ::std::declval< typename T1::value_type >() + ::std::declval< typename T2::value_type >() ), ( ::std::declval< typename T1::value_type >() + ::std::declval< typename T2::value_type >() ) > > > : public ::std::true_type { };
...
template < class T1, class T2 > struct elements_are_subtractive< T1, T2, ::std::enable_if_t< ::std::is_same_v< ( ::std::declval< typename T1::value_type >() - ::std::declval< typename T2::value_type >() ), ( ::std::declval< typename T1::value_type >() - ::std::declval< typename T2::value_type >() ) > > > : public ::std::true_type { };
...
template < class T1, class T2 > struct elements_are_multiplicative< T1, T2, ::std::enable_if_t< ::std::is_same_v< ( ::std::declval< typename T1::value_type >() * ::std::declval< typename T2::value_type >() ), ( ::std::declval< typename T1::value_type >() * ::std::declval< typename T2::value_type >() ) > > > : public ::std::true_type { };
...
template < class S, class T > struct tensor_is_scalar_premultiplicative< S, T, ::std::enable_if_t< ::std::is_same_v< ( ::std::declval< S >() * ::std::declval< typename T::value_type >() ), ( ::std::declval< S >() * ::std::declval< typename T::value_type >() ) > > > : public ::std::true_type { };
...
template < class S, class T > struct tensor_is_scalar_postmultiplicative< S, T, ::std::enable_if_t< ::std::is_same_v< ( ::std::declval< typename T::value_type >() * ::std::declval< S >() ), ( ::std::declval< typename T::value_type >() * ::std::declval< S >() ) > > > : public ::std::true_type { };
...
template < class V, class M > struct vector_matrix_may_be_multiplicative< V, M, ::std::enable_if_t< ( V::extents_type::static_extent(0) == M::extents_type::static_extent(0) ) || ( V::extents_type::static_extent(0) == ::std::experimental::dynamic_extent ) || ( M::extents_type::static_extent(0) == ::std::experimental::dynamic_extent ) > > : public ::std::true_type { };
...
template < class M, class V > struct matrix_vector_may_be_multiplicative< M, V, ::std::enable_if_t< ( V::extents_type::static_extent(0) == M::extents_type::static_extent(1) ) || ( V::extents_type::static_extent(0) == ::std::experimental::dynamic_extent ) || ( M::extents_type::static_extent(1) == ::std::experimental::dynamic_extent ) > > : public ::std::true_type { };
