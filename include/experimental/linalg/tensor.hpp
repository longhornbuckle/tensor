...
//==================================================================================================
//
#ifndef LINEAR_ALGEBRA_TENSOR_HPP
#define LINEAR_ALGEBRA_TENSOR_HPP
...
/// @tparam CapExtents defines the capacity of the tensor
...
class tensor
{
  public:
    ...
    /// @brief Type used to express capacity of tensor
  ...
  public:
    ...
    constexpr tensor() noexcept( ::std::is_nothrow_default_constructible_v<allocator_type> &&
                                 ( extents_type::rank_dynamic() != 0 ) );
    /// @brief Move constructor
    /// @param rhs tensor to be moved
    ...
    constexpr tensor( const ::std::initializer_list<value_type>& il, const extents_type& s, const allocator_type& alloc = allocator_type() );
    ...
    template < class R >
    explicit constexpr tensor( [[maybe_unused]] ::std::from_range_t, R&& rg, const allocator_type& alloc = allocator_type() )
    #ifdef LINALG_ENABLE_CONCEPTS
    ...
    /// @param alloc allocator 
    template < class R >
    constexpr tensor( [[maybe_unused]] ::std::from_range_t, R&& rg, const extents_type& s, const allocator_type& alloc = allocator_type() )
    #ifdef LINALG_ENABLE_CONCEPTS
      requires ::std::ranges::input_range< R >
    #endif
    ;
    ...
    explicit constexpr tensor( const allocator_type& alloc ) noexcept( extents_type::rank_dynamic() != 0 );
...
//-------------------------------------------------------
// Implementation of tensor< T, Extents, LayoutPolicy, CapExtents, Allocator, AccessorPolicy >
//-------------------------------------------------------

//- Destructor / Constructors / Assignments

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
LINALG_CONSTEXPR_DESTRUCTOR tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::~tensor()
  noexcept( ::std::is_nothrow_destructible_v<typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::element_type> )
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor()
  noexcept( ::std::is_nothrow_default_constructible_v< typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::allocator_type > &&
            ( extents_type::rank_dynamic() != 0 ) ) :
  tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>( allocator_type() )
{
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( tensor&& rhs ) noexcept :
  // Move accessor
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( tensor&& rhs, const allocator_type& alloc ) :
  // Move accessor
  accessor_( ::std::move( rhs.accessor_ ) ),
  // Move capacity extents
  cap_map_( ::std::move( rhs.cap_map_ ) ),
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( const tensor& rhs ) :
  // Copy accessor
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( const tensor& rhs, const allocator_type& alloc ) :
  // Copy accessor
  accessor_( rhs.accessor_ ),
  // Copy capacity extents
  cap_map_( rhs.cap_map_ ),
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::
tensor( const ::std::initializer_list<value_type>& il, const extents_type& s, const allocator_type& alloc ) :
  accessor_(),
  cap_map_( s ),
  size_map_( s ),
  tm_( alloc, cap_map_ )
...
template < class InputIt >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::
tensor( InputIt first, InputIt last, const extents_type& s, const allocator_type& alloc )
  requires ::std::input_iterator< InputIt > :
  accessor_(),
  cap_map_( s ),
  size_map_( s ),
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
template < class R >
constexpr tensor( [[maybe_unused]] ::std::from_range_t, R&& rg, const allocator_type& alloc )
#ifdef LINALG_ENABLE_CONCEPTS
  requires ::std::ranges::input_range< R >
#endif
  :
  tensor( ::std::from_range_t(), rg, extents_type(), alloc )
{
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
template < class R >
constexpr tensor( [[maybe_unused]] ::std::from_range_t, R&& rg, const extents_type& s, const allocator_type& alloc )
#ifdef LINALG_ENABLE_CONCEPTS
  requires ::std::ranges::input_range< R >
#endif
  :
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( const allocator_type& alloc ) noexcept( extents_type::rank_dynamic() != 0 ) :
  accessor_(),
  cap_map_(),
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::tensor( extents_type s, const allocator_type& alloc ) :
  accessor_(),
  cap_map_( s ),
  size_map_( this->cap_map_ ),
  tm_( alloc, this->cap_map_ )
...
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::operator = ( tensor&& rhs )
  noexcept( typename ::std::allocator_traits<typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::allocator_type>::propagate_on_container_move_assignment{} )
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>&
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::operator = ( const tensor& rhs )
{
  if constexpr ( ::std::is_trivially_destructible_v<element_type> )
  {
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>&
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::operator = ( const initializer_list<value_type>& il )
{
  if constexpr ( is_always_exhaustive() )
  {
...
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::empty() const noexcept
{
  return ( this->size() == 0 );
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr const typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::extents_type&
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::extents() const noexcept
{
  return this->size_map_.extents();
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::extent( rank_type n ) const noexcept
{
  return this->size_map_.extents().extent( n );
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::static_extent( rank_type n ) noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::max_size() const noexcept
{
  return ::std::allocator_traits<allocator_type>::max_size( this->alloc_ );
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::extents_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::capacity() const noexcept
{
  return this->cap_;
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::resize( extents_type new_size )
{
  ...
  {
    // Copy current state
    tensor clone = ::std::move( *this );
    // Set to new size
    *this = tensor( new_size, max_extents( new_size, this->capacity() ), this->get_allocator() );
    // Copy view
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::reserve( extents_type new_cap )
{
  ...
  if ( !LINALG_DETAIL::sufficient_extents( this->cap_, new_cap ) )
  {
    ...
    tensor clone = ::std::move( *this );
    // Set to new size
    *this = tensor( this->size(), max_extents( new_cap, this->capacity() ), this->get_allocator() );
    // Copy view
    LINALG_DETAIL::assign_view( *this, clone );
  }
}
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::shrink_to_fit()
{
  // Copy current state
  tensor clone = ::std::move( *this );
  // Set to new tensor with size and capacity matching
  *this = tensor( this->size(), this->get_allocator() );
  // Copy view
  LINALG_DETAIL::assign_view( *this, clone );
}
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_unique() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_exhaustive() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_strided() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_always_unique() noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_always_exhaustive() noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr bool
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::is_always_strided() noexcept
{
  return mapping_type::is_always_strided();
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::rank_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::rank() noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::rank_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::rank_dynamic() noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::size_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::stride( rank_type n ) const noexcept
{
  return this->size_map_.stride( n );
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr const typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::mapping_type&
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::mapping() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::allocator_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::get_allocator() const noexcept
{
  return this->tm_.get_allocator();
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] constexpr const typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::accessor_type&
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::accessor() const noexcept
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
template < class MDS >
inline void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::copy_view_except( MDS&& span )
{
  try
  {
    // Copy construct all elements
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] inline constexpr const typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::data_handle_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::data_handle() const noexcept
{
  return this->tm_.data();
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
[[nodiscard]] inline constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::data_handle_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::data_handle() noexcept
{
  return this->tm_.data();
}

template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::destroy_all()
  noexcept( ::std::is_nothrow_destructible_v<typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::element_type> )
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
inline void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::destroy_all_except()
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::construct_all()
  noexcept( ::std::is_nothrow_constructible_v<typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::element_type> )
{
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
inline void tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::construct_all_except()
{
  // Cache the last exception to be thrown
  ::std::exception_ptr eptr;
...
template < class SizeType, SizeType ... Indices >
constexpr void
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::
...
template < class T, class Extents, class LayoutPolicy, class CapExtents, class Allocator, class AccessorPolicy >
constexpr typename tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::extents_type
tensor<T,Extents,LayoutPolicy,CapExtents,Allocator,AccessorPolicy>::
...
#endif  //- LINEAR_ALGEBRA_TENSOR_HPP
