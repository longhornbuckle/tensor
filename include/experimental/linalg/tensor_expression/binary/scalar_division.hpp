//==================================================================================================
//  File:       scalar_division.hpp
//
//  Summary:    This header defines:
//              LINALG::accessor_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
//              LINALG::allocator_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
//              LINALG::layout_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
//              LINALG::is_alias_assignable< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
//              LINALG_EXPRESSIONS_DETAIL::scalar_division_tensor_expression_traits< Tensor, Scalar >
//              LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar >
//              LINALG::operator / ( const Tensor& t, const Scalar& s )
//              LINALG::operator /= ( Tensor& t, const Scalar& s )
//==================================================================================================

#ifndef LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SCALAR_DIVISION_HPP
#define LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SCALAR_DIVISION_HPP
...
struct accessor_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
{
...
struct accessor_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar, Enable > >
{
  using type = rebind_accessor_t< typename ::std::remove_reference_t< Tensor >::accessor_type,
                                  decltype( ::std::declval< Scalar >() + ::std::declval< typename ::std::remove_reference_t< Tensor >::value_type >() ) >;
};
...
struct allocator_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
{
  using type = typename allocator_result< Tensor >::type;
  [[nodiscard]] static inline constexpr type get_allocator( const LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar >& t ) noexcept
  {
...
struct allocator_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar, Enable > >
{
  using type = typename allocator_result< Tensor >::type;
  [[nodiscard]] static inline constexpr type get_allocator( const LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar, Enable >& t ) noexcept
  {
    return allocator_result< Tensor >::get_allocator( t.first() );
  }
};
...
struct layout_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
{
...
struct layout_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > >
{
  using type = typename layout_result< ::std::remove_reference_t< LINALG_EXPRESSIONS::scalar_division_tensor_expression< decltype( ::std::declval< Tensor >().operator auto() ), Scalar > > >::type;
};

#else

template < class Scalar, class Tensor, class Enable >
struct layout_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar, Enable > >
{
private:
  template < class T >
  ...
  {
    using type = typename layout_result< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Scalar, decltype( ::std::declval< Tensor >().operator auto() ) > >::type;
  };
public:
...
//-----------------------
template < class Tensor, class Scalar >
struct is_alias_assignable< LINALG_EXPRESSIONS::scalar_division_tensor_expression< Tensor, Scalar > > :
...
template < class Tensor, class Scalar >
class scalar_division_tensor_expression_traits
{
  public:
    // Aliases
...
class scalar_division_tensor_expression :
  public LINALG_EXPRESSIONS_DETAIL::binary_tensor_expression_base< scalar_division_tensor_expression< Tensor, Scalar >,
                                                                   LINALG_EXPRESSIONS_DETAIL::scalar_division_tensor_expression_traits< Tensor, Scalar > >
#else
template < class Tensor, class Scalar, typename Enable >
class scalar_division_tensor_expression :
  public LINALG_EXPRESSIONS_DETAIL::binary_tensor_expression_base< scalar_division_tensor_expression< Tensor, Scalar, Enable >,
                                                                   LINALG_EXPRESSIONS_DETAIL::scalar_division_tensor_expression_traits< Tensor, Scalar > >
#endif
{
  private:
    #ifdef LINALG_ENABLE_CONCEPTS
    using self_type   = scalar_division_tensor_expression< Tensor, Scalar >;
    #else
    using self_type   = scalar_division_tensor_expression< Tensor, Scalar, Enable >;
    #endif
    using traits_type = LINALG_EXPRESSIONS_DETAIL::scalar_division_tensor_expression_traits< Tensor, Scalar >;
    using base_type   = LINALG_EXPRESSIONS_DETAIL::binary_tensor_expression_base< self_type, traits_type >;
  public:
    // Special member functions
    constexpr scalar_division_tensor_expression( Tensor&& t, Scalar&& s ) noexcept : t_(t), s_(s) {}
...
#endif
{
  return LINALG_EXPRESSIONS::scalar_division_tensor_expression< const T&, const S& >( t, s );
}
...
#endif
{
  return t = LINALG_EXPRESSIONS::scalar_division_tensor_expression< T&, const S& >( t, s );
}

LINALG_END // linalg namespace

#endif  //- LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SCALAR_DIVISION_HPP
