...
//              LINALG::accessor_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
//              LINALG::allocator_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
//              LINALG::layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
//              LINALG::is_alias_assignable< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
//              LINALG_EXPRESSIONS_DETAIL::subtraction_tensor_expression_traits< FirstTensor, SecondTensor >
//              LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor >
//              LINALG::operator - ( const T1& t1, const T2& t2 )
//              LINALG::operator = ( T1& t1, const T2& t2 )
//==================================================================================================

#ifndef LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SUBTRACTION_HPP
#define LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SUBTRACTION_HPP
...
struct accessor_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
{
...
struct accessor_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor, Enable > >
{
  using type = rebind_accessor_t< typename ::std::remove_reference_t< FirstTensor >::accessor_type,
                                  decltype( ::std::declval< typename ::std::remove_reference_t< FirstTensor >::value_type >() - ::std::declval< typename ::std::remove_reference_t< SecondTensor >::value_type >() ) >;
};
...
template < class FirstTensor, class SecondTensor, class Enable >
struct allocator_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor, Enable > >
{
private:
...
struct layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
{
...
struct layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
{
  using type = typename layout_result< ::std::remove_reference_t< LINALG_EXPRESSIONS::subtraction_tensor_expression< decltype( ::std::declval< FirstTensor >().operator auto() ), SecondTensor > > >::type;
};
...
struct layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
{
  using type = typename layout_result< ::std::remove_reference_t< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, decltype( ::std::declval< SecondTensor >().operator auto() ) > > >::type;
};
...
struct layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > >
{
  using type = typename layout_result< ::std::remove_reference_t< LINALG_EXPRESSIONS::subtraction_tensor_expression< decltype( ::std::declval< FirstTensor >().operator auto() ), decltype( ::std::declval< SecondTensor >().operator auto() ) > > >::type;
};

#else

template < class FirstTensor, class SecondTensor, class Enable >
struct layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor, Enable > >
{
private:
  ...
  {
    using type = typename layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, decltype( ::std::declval< SecondTensor >().operator auto() ) > >::type;
  };
  template < class T, class U >
  struct unevaluated_unevaluated_helper
  {
    using type = typename layout_result< LINALG_EXPRESSIONS::subtraction_tensor_expression< decltype( ::std::declval< FirstTensor >().operator auto() ), decltype( ::std::declval< SecondTensor >().operator auto() ) > >::type;
  };
public:
...
//-----------------------
template < class FirstTensor, class SecondTensor >
struct is_alias_assignable< LINALG_EXPRESSIONS::subtraction_tensor_expression< FirstTensor, SecondTensor > > :
...
template < class FirstTensor, class SecondTensor >
class subtraction_tensor_expression_traits
{
  public:
    // Aliases
...
class subtraction_tensor_expression :
  public LINALG_EXPRESSIONS_DETAIL::binary_tensor_expression_base< subtraction_tensor_expression< FirstTensor, SecondTensor >,
                                                                   LINALG_EXPRESSIONS_DETAIL::subtraction_tensor_expression_traits< FirstTensor, SecondTensor > >
#else
template < class FirstTensor, class SecondTensor, typename Enable >
class subtraction_tensor_expression :
  public LINALG_EXPRESSIONS_DETAIL::binary_tensor_expression_base< subtraction_tensor_expression< FirstTensor, SecondTensor, Enable >,
                                                                   LINALG_EXPRESSIONS_DETAIL::subtraction_tensor_expression_traits< FirstTensor, SecondTensor > >
#endif
{
  private:
    ...
    #endif
    using traits_type = LINALG_EXPRESSIONS_DETAIL::subtraction_tensor_expression_traits< FirstTensor, SecondTensor >;
...
#endif
{
  return LINALG_EXPRESSIONS::subtraction_tensor_expression< const T1&, const T2& >( t1, t2 );
}
...
#endif
{
  return t1 = LINALG_EXPRESSIONS::subtraction_tensor_expression< T1&, const T2& >( t1, t2 );
}

LINALG_END // linalg namespace

#endif  //- LINEAR_ALGEBRA_TENSOR_EXPRESSION_BINARY_SUBTRACTION_HPP
